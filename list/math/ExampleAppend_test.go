...
func ExampleAppend() {
	...
	plus.AddList(math.Append(nil))
	plus.AddList(math.Append(nil, ds))
	plus.AddList(math.Append(ds))
	plus.AddList(math.Append(ds, as))
	plus.AddList(math.Append(ds, as, nil))
	plus.AddList(math.Append(ds, as, bs))

	var mult = dark.AddBeam("Times")
	mult.AddList(math.Times(nil))
	mult.AddList(math.Times(nil, ds))
	mult.AddList(math.Times(ds, nil))
	mult.AddList(math.Times(ds))
	mult.AddList(math.Times(ds, ws))
	mult.AddList(math.Times(ds, ws, bs))
	mult.AddList(math.Times(bs, ws, ds))
